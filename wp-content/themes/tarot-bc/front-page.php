    ...
    <div class="container chikurov_info">
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <a href="https://shop-bc.com/product/kniga-lechebnoe-tarot-chikurov-yuv" target="_blank" class="seminars_link btn btn-primary btn-lg">Купить бумажное издание</a>
        </div>
