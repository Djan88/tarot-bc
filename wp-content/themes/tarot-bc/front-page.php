    ...
    <div class="container chikurov_info">
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <a href="https://shop-bc.com/product/kniga-lechebnoe-tarot-chikurov-yuv" target="_blank" class="book_link btn btn-primary btn-lg">Бумажное издание</a>
          <a target="_blank" href="<?php bloginfo('template_url'); ?>/img/reference.pdf" class="reference_link btn btn-link btn-lg">Предметный указатель</a>
        </div>
