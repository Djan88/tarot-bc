<?php get_header(); ?>
    ...
    <div class="container chikurov_info">
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <a href="https://chikurov.com" target="_blank" class="seminars_link btn btn-success btn-lg">Школа Доктора Чикурова</a>
        </div>
      </div>
    </div>
  </section>
  <section class="doctor seminars_light" id="course">
    <div class="container chikurov_info">
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          <h1 class="main_heading">Онлайн курс «Лечебное Tarot»</h1>
          <div class="doctor_about tarot_about">
          ...
          <a href="http://school-bc.ru/" class="seminars_link btn btn-success btn-lg cur_page_ridden">Онлайн курс</a>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
