      ...
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <div class="doctor_about tarot_about">
            <h3>Возможности уникального метода:</h3>
            <ol>
            ...
            <p>Зарегистрируйтесь и получите в подарок бесплатный онлайн-курс и возможность читать книгу Лечебное Tarot онлайн</p>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
          <img class="chikurov_img" src="<?php bloginfo('template_url'); ?>/img/tarot.png" alt="Чикуров Ю.В.">
        </div>
      </div>
    </div>
  </section>
